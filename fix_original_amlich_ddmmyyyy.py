#!/usr/bin/env python3
"""
Script để sửa lại định dạng ngày âm lịch thành dd/mm/yyyy cho các trang prayer gốc
"""
...
def fix_original_amlich_ddmmyyyy(file_name):
    """Sửa định dạng ngày âm lịch thành dd/mm/yyyy cho một trang prayer gốc"""
...
'''
    ...
    print(f"✅ Đã sửa định dạng dd/mm/yyyy {file_name}")
    return True

def main():
    """Main function"""
    print("Đang sửa lại định dạng ngày âm lịch thành dd/mm/yyyy cho các trang prayer gốc...")
    print()
    ...
    for file_name in original_files:
        if fix_original_amlich_ddmmyyyy(file_name):
            success_count += 1
