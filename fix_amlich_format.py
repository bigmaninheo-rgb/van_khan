#!/usr/bin/env python3
"""
Script để sửa lại định dạng ngày âm lịch - thêm năm vào định dạng
"""
...
def fix_amlich_format(prayer_num):
    """Sửa định dạng ngày âm lịch cho một trang prayer"""
    ...
    # 3. Cập nhật JavaScript với định dạng mới
...
'''
    ...
    print(f"✅ Đã sửa định dạng prayer{prayer_num}.html")
    return True

def main():
    """Main function"""
    print("Đang sửa lại định dạng ngày âm lịch...")
    print("🔧 Cải thiện:")
    print("  - Thêm năm vào định dạng ngày âm lịch")
    print("  - Định dạng đầy đủ: ngày 21 tháng Hai năm Ất Dậu")
    print()
