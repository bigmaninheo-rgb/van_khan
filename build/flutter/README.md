...
* `van_khan` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `van-khan` - executable or bundle name on disk.
* `van-khan` - display name shown in window titles and about app dialogs.
